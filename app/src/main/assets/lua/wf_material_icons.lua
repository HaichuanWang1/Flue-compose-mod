-- wf_material_icons.lua — GENERATED, do not edit by hand.
-- Material Icons ligature-name -> Private-Use codepoint map, extracted from the
-- classic MaterialIcons-Regular.ttf GSUB(type4)+cmap via fontTools. Each ligature's
-- input is rebuilt from its component glyphs' Unicode (so 'directions_walk' keeps its
-- underscore). Codepoints are canonical/stable across Outlined/Round/Sharp/TwoTone.
-- Consumed by Builders.text in wf_render.lua (Axmol does no GSUB ligature shaping).
return {
  ["10k"]=0xE951,
  ["10mp"]=0xE952,
  ["11mp"]=0xE953,
